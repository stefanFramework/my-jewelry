...
class BaseConfig:
    ...
    LOG_FILENAME = normpath(join(BASE_DIR, 'logs/mj-api.log'))
    LOG_LEVEL = 'INFO'
...
class DevelopmentConfig(BaseConfig):
    DEBUG = True
    SQLALCHEMY_TRACK_MODIFICATIONS = False
    SQLALCHEMY_DATABASE_URI = 'postgresql://mj:1234@mj-db/mjdb'
...
if 'MJ_ENV' not in os.environ:
    os.environ['MJ_ENV'] = 'development'

env = os.environ['MJ_ENV']
